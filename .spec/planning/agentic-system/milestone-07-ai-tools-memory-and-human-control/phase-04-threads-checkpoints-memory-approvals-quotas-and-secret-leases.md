...
- [x] 4.4 Section - Define integrated verification for threads checkpoints memory approvals quotas and secret leases across its real dependency boundaries.
  ...
  - [x] 4.4.1 Task - Define the phase integration scenarios.
    ...
    - [x] 4.4.1.1 Subtask - Define a scenario for the canonical successful flow and retained evidence for threads checkpoints memory approvals quotas and secret leases.
