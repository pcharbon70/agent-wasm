...
- [x] 1.4 Section - Verify provider-neutral model requests responses streaming and usage across its real dependency boundaries.
  ...
  - [x] 1.4.1 Task - Run the phase integration scenarios.
    ...
    - [x] 1.4.1.1 Subtask - Verify the canonical successful flow and retained evidence for provider-neutral model requests responses streaming and usage.
