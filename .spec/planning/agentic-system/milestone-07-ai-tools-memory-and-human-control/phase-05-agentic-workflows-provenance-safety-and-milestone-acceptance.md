...
- [x] 5.4 Section - Verify agentic workflows provenance safety and milestone acceptance across its real dependency boundaries.
  ...
  - [x] 5.4.1 Task - Run the phase integration scenarios.
    ...
    - [x] 5.4.1.1 Subtask - Verify the canonical successful flow and retained evidence for agentic workflows provenance safety and milestone acceptance.
