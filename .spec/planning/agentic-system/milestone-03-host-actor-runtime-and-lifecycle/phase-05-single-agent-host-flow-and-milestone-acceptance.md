...
- [x] 5.4 Section - Define integrated verification for single-agent host flow and milestone acceptance across its real dependency boundaries.
  ...
  - [x] 5.4.1 Task - Define the phase integration scenarios.
    ...
    - [x] 5.4.1.1 Subtask - Define a scenario for the canonical successful flow and retained evidence for single-agent host flow and milestone acceptance.
