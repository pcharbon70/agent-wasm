...
- [x] 2.4 Section - Define integrated verification for mailboxes ordering bounds fairness and turn leases across its real dependency boundaries.
  ...
  - [x] 2.4.1 Task - Define the phase integration scenarios.
    ...
    - [x] 2.4.1.1 Subtask - Define a scenario for the canonical successful flow and retained evidence for mailboxes ordering bounds fairness and turn leases.
