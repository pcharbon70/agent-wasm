...
- [x] 4.4 Section - Verify sensors schedules timers and external signal ingress across its real dependency boundaries.
  ...
  - [x] 4.4.1 Task - Run the phase integration scenarios.
    ...
    - [x] 4.4.1.1 Subtask - Verify the canonical successful flow and retained evidence for sensors schedules timers and external signal ingress.
