...
- [x] 3.4 Section - Verify agent manifests artifacts schemas and registries across its real dependency boundaries.
  ...
  - [x] 3.4.1 Task - Run the phase integration scenarios.
    ...
    - [x] 3.4.1.1 Subtask - Verify the canonical successful flow and retained evidence for agent manifests artifacts schemas and registries.
