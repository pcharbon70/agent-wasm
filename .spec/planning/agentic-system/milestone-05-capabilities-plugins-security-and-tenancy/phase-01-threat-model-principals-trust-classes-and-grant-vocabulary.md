...
- [x] 1.4 Section - Verify threat model principals trust classes and grant vocabulary across its real dependency boundaries.
  ...
  - [x] 1.4.1 Task - Run the phase integration scenarios.
    ...
    - [x] 1.4.1.1 Subtask - Verify the canonical successful flow and retained evidence for threat model principals trust classes and grant vocabulary.
