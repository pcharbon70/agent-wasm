...
- [x] 4.4 Section - Verify synchronous host functions wasi restrictions and tenant isolation across its real dependency boundaries.
  ...
  - [x] 4.4.1 Task - Run the phase integration scenarios.
    ...
    - [x] 4.4.1.1 Subtask - Verify the canonical successful flow and retained evidence for synchronous host functions wasi restrictions and tenant isolation.
