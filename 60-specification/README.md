...
- [Provider-Neutral Model Requests Responses Streaming And Usage Contract And Data Model](41-provider-neutral-model-requests-responses-streaming-and-usage-contract-and-data-model.md) — Phase 1 of Milestone 7; establishes the contract and data model for provider-neutral model requests, responses, streaming, and usage, including model request identity, provider constraints, response normalization, streaming normalization, and usage tracking.
- [Provider-Neutral Model Requests Responses Streaming And Usage Behavior And Integration](41-provider-neutral-model-requests-responses-streaming-and-usage-behavior-and-integration.md) — Phase 1 of Milestone 7; establishes the behavior and integration rules for provider-neutral model requests, responses, streaming, and usage, including provider adapter behavior, capability mapping, signal conversion, cancellation, retry classification, and outcome definitions.
- [Provider-Neutral Model Requests Responses Streaming And Usage Failure Evidence And Operational Notes](41-provider-neutral-model-requests-responses-streaming-and-usage-failure-evidence-and-operational-notes.md) — Phase 1 of Milestone 7; establishes the failure evidence and operational notes for provider-neutral model requests, responses, streaming, and usage, including failure outcomes, bounded diagnostics, evidence emission, and implementation-defined choices.
- [Provider-Neutral Model Requests Responses Streaming And Usage Phase 1 Integration Tests](41-provider-neutral-model-requests-responses-streaming-and-usage-phase-1-integration-tests.md) — Phase 1 of Milestone 7; defines the integration tests that verify provider-neutral model requests, responses, streaming, and usage across its real dependency boundaries.
- [Tool Catalogs Retrieval Code Execution And Connectors Contract And Data Model](42-tool-catalogs-retrieval-code-execution-and-connectors-contract-and-data-model.md) — Phase 2 of Milestone 7; establishes the contract and data model for tool catalogs, retrieval, code execution, and connectors, including tool descriptors, retrieval requests, code-execution requests, and connector registration.
- [Tool Catalogs Retrieval Code Execution And Connectors Behavior And Integration](42-tool-catalogs-retrieval-code-execution-and-connectors-behavior-and-integration.md) — Phase 2 of Milestone 7; establishes the behavior and integration rules for tool catalogs, retrieval, code execution, and connectors, including tool resolution, catalog policy filtering, execution through durable effect attempts, and outcome definitions.
- [Tool Catalogs Retrieval Code Execution And Connectors Failure Evidence And Operational Notes](42-tool-catalogs-retrieval-code-execution-and-connectors-failure-evidence-and-operational-notes.md) — Phase 2 of Milestone 7; establishes the failure evidence and operational notes for tool catalogs, retrieval, code execution, and connectors, including failure outcomes, bounded diagnostics, evidence emission, implementation-defined choices, and deferred work.
- [Tool Catalogs Retrieval Code Execution And Connectors Phase 2 Integration Tests](42-tool-catalogs-retrieval-code-execution-and-connectors-phase-2-integration-tests.md) — Phase 2 of Milestone 7; defines the integration tests that verify tool catalogs, retrieval, code execution, and connectors across their real dependency boundaries.
